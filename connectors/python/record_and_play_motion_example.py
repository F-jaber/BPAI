...
class Example:
    ...
    def run(self) -> None:
        ...
        self.action_runner.run_waiting_action('say', 'You can now move my right arm.')
        self.action_runner.run_waiting_action('start_record_motion', joints, 100)
        # self.action_runner.run_loaded_actions()
        sleep(8)
        ...
        self.action_runner.run_waiting_action('say', 'Finished recording')
        print(self.motion)
        # self.action_runner.run_loaded_actions()
        ...
        if self.motion:
            ...
            self.action_runner.run_waiting_action('say', 'Great! Finish playing the movement. I am going to rest')
        else:
